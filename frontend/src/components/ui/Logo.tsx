import { OpenSourceLogoIcon } from "../icons";
  ...
  return (
    <div className="flex items-center">
      <div className="flex-shrink-0 flex items-center space-x-3 hover:scale-105 transition-transform duration-300 ease-out cursor-pointer">
        <div>
          <OpenSourceLogoIcon className="h-12 w-12 text-primary-500 transition-transform duration-300 ease-out hover:rotate-12" />
        </div>
